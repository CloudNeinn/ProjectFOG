...
public class playerHealthManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        charRigid = charCon.gameObject.GetComponent<Rigidbody2D>(); 
    ...
    {   
        if(isDamageable && !barrierActive)
        {
            ...
            if(enemy != null)
            {
                ...
                Vector2 force = new Vector2(knockbackStrengthX * -enemy.attackDirection(), knockbackStrengthY);
    ...
    public void Barrier()
    {
        ...
        if(charCon.hasBarrier && Input.GetKeyDown(KeyCode.B) && !barrierActive && barrierCooldownCounter <= 0)
        {
            barrierActive = true;
    ...
    IEnumerator knockBackTime()
    {
        ...
        charCon.anim.SetBool("isMoving", false);
        canMove = true;
    }
}
