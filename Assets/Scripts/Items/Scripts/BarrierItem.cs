...
public class BarrierItem : Item
{
    public override void Execute()
    {
        ...
        if(characterControl.Instance._activeItem1Input/*Input.GetKeyDown(KeyCode.B)*/ && !playerHealthManager.Instance.barrierActive && playerHealthManager.Instance.barrierCooldownCounter <= 0)
        {
